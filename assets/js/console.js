...
var ConsoleLogViewer = (function() {
	...
	{
		var css = '#debug_console { background: rgba(0,0,0,.75); padding:0; margin:0; z-index:12834567; box-sizing:border-box; pointer-events:none; text-align:left; text-transform:none; width: 75%;overflow: scroll; }';
